...
//
// ¿CÓMO funciona?
// En JSX, style acepta un OBJETO (no un string como en HTML).
// Las propiedades CSS se escriben en camelCase: font-size → fontSize.
// Útil para estilos dinámicos; no recomendado para estilos estáticos.
//
...
// Ejemplo COMPLETO: componente con variantes usando Tailwind + CVA
// ============================================
import { cva, type VariantProps } from 'class-variance-authority';

// CVA: define variantes type-safe para Tailwind
...
// Props: VariantProps extrae los tipos automáticamente de CVA
...
export default function Button({
  children, variant, size, fullWidth, loading, className, ...props
}: ButtonProps) {
  return (
    <button
...
// <Button variant="outline" fullWidth loading>Procesando...</Button>
// <Button variant="secondary" disabled>Deshabilitado</Button>

// npm install class-variance-authority  (si usas CVA)`;
...
export default function EstilosPage() {
  return (
    <div>
      ...
      <p className="text-text-muted mb-4">
        Componente Button con variantes type-safe usando CVA + Tailwind: 5 variantes de estilo,
        3 tamaños, loading state, y props extendidas de HTMLButtonElement.
      </p>
      <CodeBlock code={ejemploGithub} language="tsx" filename="src/components/Button.tsx" />
    </div>
  );
}
